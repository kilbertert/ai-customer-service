...
class Tenant(TypeBase):
    ...
    # basjoo M11 PR1: admin-provision metadata (24h TTL, see m11-pr1-dify-fork.md §7)
    custom_idempotency_key: Mapped[str | None] = mapped_column(String(36), nullable=True, default=None)
    created_via_admin_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True, default=None)
    initial_password_plain: Mapped[str | None] = mapped_column(String(64), nullable=True, default=None)
