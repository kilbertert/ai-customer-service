...
`services.dify.sse_bytes` 公共模块（DRY 修复，与 `sse_proxy_layer.py` 共享）。
"""
...
from services.dify.dify_client import DifyClient, DifyError, DifyUpstreamError
from services.dify.response_parser import extract_assistant_text
from services.dify.schemas import ChatResponse
...
log = logging.getLogger("services.dify")
