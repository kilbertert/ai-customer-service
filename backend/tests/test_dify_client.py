...
class TestStripThinking:
    ...
    def test_empty_string(self):
        from services.dify.dify_client import _strip_thinking
...
class TestParseSseEvent:
    ...
    def test_empty_data_returns_none(self):
        from services.dify.dify_client import _parse_sse_event
...
class TestDefensiveErrorPaths:
    ...
    def test_safe_body_text_handles_unreadable_body(self):
        from services.dify.dify_client import _safe_body_text
        class _BadResp:
            @property
            def text(self):
    ...
    async def test_safe_aread_handles_unreadable_body(self):
        from services.dify.dify_client import _safe_aread
        class _BadResp:
